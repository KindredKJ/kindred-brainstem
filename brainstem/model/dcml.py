...
from brainstem.model.advanced import AdvancedDCML
...
class DCMLLearning:
    ...
    def _advanced_proposal(
        ...
        self.store.event(
            "dcml.advanced_learning_proposed",
            {"learning_id": learning_id, "kind": kind},
        )
        return learning_id
